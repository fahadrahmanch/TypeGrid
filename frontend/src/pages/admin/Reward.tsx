    ...
    const handleSubmit = async () => {
        ...
        try {
            if (isEditOpen && selectedRewardId) {
               ...
               const response= await createReward({ xp: Number(values.xp), description: values.description });
                        ...
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {loading ? (
                                    ...
                                    <tr>
                                        <td colSpan={3} className="py-20 text-center text-gray-400 font-medium">No rewards found</td>
                                    </tr>
                                ) : rewards.map((reward) => (
