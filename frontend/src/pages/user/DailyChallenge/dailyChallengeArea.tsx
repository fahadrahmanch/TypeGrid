              ...
              <div className="bg-white/60 shadow-sm border border-orange-50/50 rounded-lg p-3 mb-3 text-center max-w-lg mx-auto backdrop-blur-sm">
                <p className="text-gray-600 text-[11px] font-medium leading-relaxed">
                  {challenge?.challengeId.description ||
                    "Test your speed and accuracy in today's specially curated typing lesson."}
                </p>
              </div>
              ...
              <div className="grid grid-cols-7 gap-1">
                ...
                {monthDays.map((d) => {
                  ...
                  return (
                    <div
                      key={d}
                      className={`aspect-square flex items-center justify-center text-[7px] font-black rounded-md transition-all
                                          ${
                                            isSuccess
