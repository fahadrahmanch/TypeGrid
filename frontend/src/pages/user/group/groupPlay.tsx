      ...
      <div className="pt-24 px-2 md:px-4 pb-8 max-w-[1920px] mx-auto">
        ...
        <div className="flex gap-4 mb-6">
          <button 
            ...
            className={`px-8 py-2 rounded-lg font-bold text-sm tracking-wider shadow-sm transition-colors ${
              activeTab === "LOBBY" ? "bg-[#F3E6D5] text-black" : "bg-transparent text-gray-500 hover:bg-[#F3E6D5]/50"
            }`}
          >
            LOBBY
          </button>
          <button 
            ...
            className={`px-8 py-2 rounded-lg font-bold text-sm tracking-wider shadow-sm transition-colors ${
              activeTab === "NEW GAME" ? "bg-[#F3E6D5] text-black" : "bg-transparent text-gray-500 hover:bg-[#F3E6D5]/50"
            }`}
          >
            NEW GAME
          </button>
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex gap-3">
                  <div className="relative">
                    <img src="https://via.placeholder.com/50" alt="me" className="w-12 h-12 rounded-full object-cover" />
          ...
          <div className="flex flex-col gap-6">
             <div className="bg-[#FAF9F6] rounded-2xl p-8 shadow-sm border border-[#EAEaea] min-h-[450px] flex flex-col relative">
                ...
                <div className="bg-[#F3F8F5] p-8 rounded-xl my-6 font-mono text-lg leading-relaxed text-gray-500 tracking-wide flex-1 overflow-y-auto custom-scrollbar max-h-[400px]">
                    <span className="text-green-600">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard durnmy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</span> <span className="text-red-500 underline decoration-red-500">I</span>t has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since It was popularised in the 1960s with the release of Letraset sheets containing dummy text of the printing and typesetting industry. Lorem helloo sheets containing dummy text of the printing and typesetting industry. Lorem helloo
                </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Timer Card */}
             <div className="bg-[#FAF9F6] rounded-2xl p-8 shadow-sm border border-[#EAEaea] flex flex-col items-center justify-center min-h-[160px]">
                ...
                <div className="flex flex-col gap-1 text-xs text-gray-500 w-full px-4">
                    <div className="flex justify-between">
                         <span><kbd className="font-bold font-sans">Ctrl</kbd> + <kbd className="font-bold font-sans">Esc</kbd></span>
                         <span>to exit</span>
                    </div>
                    <div className="flex justify-between">
                         <span><kbd className="font-bold font-sans">Tab</kbd></span>
             ...
             <div className="bg-[#FAF9F6] rounded-2xl p-6 shadow-sm border border-[#EAEaea] flex-1">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-lg text-gray-800">Players(72)</h3>
                </div>
                    ...
                    {players.map((player, idx) => (
                        <div key={idx} className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
                            <div className="flex items-center gap-3 mb-3">
                                <div className="relative">
                                    <img src={player.avatar || "https://via.placeholder.com/40"} className="w-10 h-10 rounded-full bg-gray-200 object-cover" alt={player.name} />
                                    {player.rank && (
