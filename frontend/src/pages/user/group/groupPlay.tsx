            ...
            <div className="flex flex-col gap-4 h-full min-h-0">
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-orange-100 p-5 rounded-3xl shadow-lg shadow-orange-900/5 group shrink-0 relative overflow-hidden">
                ...
                <div className="flex items-center gap-4 mb-6 relative">
                  ...
                  <div>
                    <h3 className="font-black text-xl text-gray-800 tracking-tight leading-tight">
                ...
                {/* Game Status Banner */}
                <div
                  className={`mb-5 p-3 rounded-2xl border flex items-center gap-3 shadow-sm transition-all duration-300 ${isFinished ? "bg-emerald-50 border-emerald-100" : "bg-orange-50 border-orange-100"}`}
                >
                  <div
                        ...
                        <div className="p-0 bg-white flex-1 overflow-y-auto custom-scrollbar">
                          <table className="w-full text-left border-collapse">
                            <thead className="bg-gray-50 sticky top-0 z-10 shadow-sm">
                              <tr>
                                <th className="py-3 px-6 text-xs font-black text-gray-400 uppercase tracking-widest text-center w-16">
                                  Rank
                                </th>
                                <th className="py-3 px-6 text-xs font-black text-gray-400 uppercase tracking-widest w-full">
                                  Player
                                </th>
                                <th className="py-3 px-6 text-xs font-black text-gray-400 uppercase tracking-widest text-center w-24">
                                  WPM
                                </th>
                                <th className="py-3 px-6 text-xs font-black text-gray-400 uppercase tracking-widest text-center w-20">
                                  ACC
                                </th>
                                <th className="py-3 px-6 text-xs font-black text-gray-400 uppercase tracking-widest text-center w-24">
                                  Result
                                  ...
                                  .map((p) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <td className="py-3 px-6">
                                          <div className="flex items-center gap-3">
                                            <div className="relative shrink-0">
                                              ...
                                              />
                                              {isWinner && (
                                                <Crown className="absolute -top-2 -right-1 w-4 h-4 text-orange-500 fill-orange-500 drop-shadow-sm" />
                                              )}
                                            </div>
                                            <div className="flex flex-col min-w-0">
                                              <div className="flex items-center gap-2">
                                                <span
                                                  className={`font-bold text-base truncate ${isMe ? "text-gray-900" : "text-gray-700"}`}
                                                >
                                                  {p.name}
                                                </span>
                                                {isMe && (
                                        ...
                                        <td className="py-3 px-6 text-center">
                                          {(p.wpm || 0) > 80 ? (
                                            <span className="inline-block px-3 py-1 rounded-full bg-green-50 text-green-700 font-bold text-xs border border-green-100">
                                              Legendary
                                            </span>
                                          ) : (p.wpm || 0) > 60 ? (
                                            <span className="inline-block px-3 py-1 rounded-full bg-blue-50 text-blue-700 font-bold text-xs border border-blue-100">
                                              Expert
                                            </span>
                                          ) : (p.wpm || 0) > 40 ? (
                                            <span className="inline-block px-3 py-1 rounded-full bg-indigo-50 text-indigo-700 font-bold text-xs border border-indigo-100">
                                              Pro
                                            </span>
                                          ) : (
                                            <span className="inline-block px-3 py-1 rounded-full bg-gray-50 text-gray-500 font-bold text-xs border border-gray-100">
                                              Rookie
                                            </span>
                                          )}
                                        </td>
                ...
                <div className="space-y-3 overflow-y-auto pr-1 custom-scrollbar min-h-0 flex-1">
                  {livePlayers.map((player) => {
                    ...
                    return (
                      <div
                        key={player._id}
                        className="bg-white rounded-xl p-3 border border-orange-100/60 shadow-[0_2px_8px_-2px_rgba(249,115,22,0.05)] hover:border-orange-200 hover:shadow-md transition-all group relative overflow-hidden"
                      >
