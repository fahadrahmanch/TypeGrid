              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <Lock
                        className={`h-5 w-5 ${errors.currentPassword ? "text-red-400" : "text-[#B99F8D] group-focus-within:text-[#9A8170]"} transition-colors duration-200`}
                      />
                    </div>
                    <input
                      ...
                      className={`block w-full pl-10 pr-10 py-3 border rounded-xl leading-5 bg-[#FAF8F6] dark:bg-gray-700/50 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#B99F8D] focus:bg-white dark:focus:bg-gray-700 transition-all duration-200 ${
                        errors.currentPassword
                          ? "border-red-500 ring-1 ring-red-500"
                          : "border-[#E0D4C8] dark:border-gray-600 hover:border-[#B99F8D] dark:hover:border-gray-500"
                      }`}
                      placeholder="••••••••••••"
                    />
                    <div
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <Lock
                        className={`h-5 w-5 ${errors.newPassword ? "text-red-400" : "text-[#B99F8D] group-focus-within:text-[#9A8170]"} transition-colors duration-200`}
                      />
                    </div>
                    <input
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <Lock
                        className={`h-5 w-5 ${errors.confirmPassword ? "text-red-400" : "text-[#B99F8D] group-focus-within:text-[#9A8170]"} transition-colors duration-200`}
                      />
                    </div>
                    <input
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className={`w-full relative overflow-hidden group text-white bg-[#B99F8D] hover:bg-[#A38676] focus:ring-4 focus:ring-[#D4C5B5] font-bold rounded-xl text-sm px-5 py-3.5 text-center shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0 ${
