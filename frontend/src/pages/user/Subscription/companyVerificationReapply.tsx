    ...
    <div className="min-h-screen flex items-center justify-center p-4 ">
      <div className="w-full max-w-lg bg-white rounded-xl shadow-lg p-8 border border-gray-100">
        ...
        <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex gap-3">
          ...
          <div>
            <h3 className="font-semibold text-yellow-800">Re-Apply for Verification</h3>
            <p className="text-sm text-yellow-700">
              Your previous request was rejected or expired. Please review and submit updated company details.
            </p>
          </div>
        </div>
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Re-Apply Company Verification</h1>
          <p className="text-gray-500 text-sm">Make sure all details are correct before submitting again.</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          {/* Company Name */}
          <div>
            <label className="block text-sm font-bold mb-2 text-start">Company Name *</label>
            <input
              type="text"
              name="companyName"
          ...
          {/* Address */}
          <div>
            <label className="block text-sm font-bold mb-2 text-start">Address *</label>
            <input
              type="text"
              name="address"
          ...
          {/* Email */}
          <div>
            <label className="block text-sm font-bold mb-2 text-start">Contact Email *</label>
            <input
              type="email"
              name="email"
              value={values.email}
          ...
          {/* Phone */}
          <div>
            <label className="block text-sm font-bold mb-2 text-start">Contact Phone *</label>
            <input
              type="tel"
              name="number"
              value={values.number}
