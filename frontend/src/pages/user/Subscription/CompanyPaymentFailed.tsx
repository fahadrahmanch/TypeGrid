    ...
    <div className="min-h-screen bg-[#FAFAFA] pt-20 pb-12 px-4 flex flex-col items-center">
      ...
      <div className="max-w-2xl w-full mt-12">
        <div className="bg-white rounded-[32px] p-8 md:p-16 border border-slate-200 shadow-xl text-center relative overflow-hidden">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">Payment Unsuccessful</h1>

          <p className="text-xl text-slate-600 mb-12 max-w-md mx-auto leading-relaxed">
            We were unable to process your company subscription payment. Don't worry,{" "}
            <span className="font-semibold text-slate-900">no charges were made</span> to your account.
          </p>
            ...
            <div className="bg-slate-50 rounded-2xl p-6 flex items-start gap-4 text-left max-w-md mx-auto">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Common issues include card restrictions or insufficient funds. If you keep having trouble, our support
                  team is ready to help.
                </p>
                <button className="mt-3 text-indigo-600 font-bold text-sm hover:underline">Talk to Support</button>
              </div>
            </div>
          </div>
        </div>
