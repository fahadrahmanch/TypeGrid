                      ...
                      <div className="flex flex-col gap-0.5">
                        {[...contestDetails.rewards]
                          ...
                          .map((reward: any) => (
                            <div
                              key={reward.rank}
                              className="flex justify-between items-center text-sm border-b last:border-0 border-gray-100 pb-0.5 last:pb-0"
                            >
                  ...
                  <div className="relative bg-white border border-gray-100 rounded-3xl shadow-lg p-6 flex flex-col items-center justify-center w-[220px] h-[160px]">
                    ...
                    {contestStatus === "waiting" ? (
                      ...
                      <>
                        ...
                        <div
                          className={`font-mono font-bold tracking-tight text-gray-900 drop-shadow-sm flex items-center ${timeLeft.days > 0 ? "text-3xl" : "text-4xl"}`}
                        >
                          {timeLeft.days > 0 && (
                            <>
                              <span>{formatTime(timeLeft.days)}</span>
                              <span className="text-orange-400 opacity-80 mx-0.5 mb-1">
                                :
                              </span>
                            </>
                          )}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 font-medium">
                      {lobbyParticipants.length} of{" "}
                      {contestDetails.maxParticipants} ready
                    </p>
                  </div>
                </div>
                  ...
                  {lobbyParticipants.map((participant: any) => (
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        <div
                          className={`w-9 h-9 rounded-lg flex items-center justify-center font-bold text-xs ${participant.color}`}
                        >
