        ...
        <div className={`bg-[#FAF3E0] rounded-2xl p-6 shadow-sm border flex flex-col transition-all hover:shadow-md ${isAccepted ? 'border-green-300 border-l-4 border-l-green-400' : isWaiting ? 'border-indigo-200 border-l-4 border-l-indigo-400' : isPending && isSent ? 'border-[#EBE3D5] border-l-4 border-l-yellow-400' : 'border-[#EBE3D5]'}`}>
            ...
            {isCompleted ? (
                ...
                <div className="mt-auto">
                    ...
                    <button className="w-full py-3 bg-[#1DCE6C] hover:bg-[#1ab860] text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-colors shadow-sm">
                ...
                <div className="mt-auto flex gap-3">
                    ...
                    <button className="flex-1 py-3 bg-[#1DCE6C] hover:bg-[#1ab860] text-white rounded-xl font-bold text-sm transition-colors shadow-sm">
                        Accept
                    </button>
                </div>
            ) : null}
