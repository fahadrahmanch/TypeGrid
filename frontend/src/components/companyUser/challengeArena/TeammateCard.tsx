...
const TeammateCard = ({ teammate, onViewChallenges }: { teammate: Teammate, onViewChallenges?: () => void }) => {
        ...
        async function checkAlreadySendChallenge() {
            try {
                ...
                if (response.data) {
                    ...
                    const receiverIds = res.map(
                        (challenge: any) => challenge.receiverId
                    )
        ...
        <div className="bg-[#FAF3E0] rounded-2xl overflow-hidden shadow-sm border border-[#EBE3D5] flex flex-col relative group hover:shadow-md transition-all">
            ...
            <div className="h-24 bg-gradient-to-r from-[#5a483e] to-[#40332c] relative">
                ...
                <div className="absolute top-4 right-4 z-10">
                    <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold shadow-sm ${teammate.online === true ? 'bg-[#1DCE6C] text-white' : 'bg-[#A8A2A0] text-white'}`}>
            ...
            <div className="px-6 flex-1 flex flex-col pb-6 relative -mt-10">
                ...
                {alreadySent ? (
                    ...
                    <button
                        ...
                        className={`w-full py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-all ${teammate.online
