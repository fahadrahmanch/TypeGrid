    ...
    return (
        <>
            <div className="bg-[#FFF3DB] w-[85rem] ml-10 pl-10 pt-6 pb-6 rounded-md shadow-sm">
                ...
                <p className="text-start text-gray-700">Manage and verify company registrations</p>
                {/* Search + Filter */}
                    ...
                    <tbody className="bg-[#FCF8F0]">
                        <tr className="border-b text-start">
                            ...
                            <td className="px-4 py-2 flex items-center gap-2">
                                <button onClick={()=>setOpen(true)} className="px-3 py-1 text-sm bg-gray-500 text-white rounded hover:bg-gray-600 transition">
                                    View Details
                                </button>   
                            </td>
                        </tr>
