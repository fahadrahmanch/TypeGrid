...
import { GetCompanyDashboardStatsUseCase } from "../../application/use-cases/company-admin/get-dashboard-stats.use-case";
import { CompanyDashboardController } from "../controllers/company-admin/company-dashboard.controller";
...
const createCompanyLessonUseCaseInstance = new CreateCompanyLessonUseCase(lessonRepository, userRepository);
const getLessonUseCaseInstance = new GetLessonUseCase(lessonRepository);
const getCompanyLessonUseCaseInstance = new GetCompanyLessonsUseCase(lessonRepository, userRepository);
const updateCompanyLessonUseCaseInstance = new UpdateCompanyLessonUseCase(lessonRepository);
const deleteCompanyLessonUseCaseInstance = new DeleteCompanyLessonUseCase(lessonRepository);
...
const getCompanygroupUseCaseInstance = new GetCompanyGroupsUseCase(userRepository, companyGroupRepository);
...
const addCompanyGroupMemberUseCaseInstance = new AddCompanyGroupMemberUseCase(userRepository, companyGroupRepository);
const deleteCompanyGroupUseCaseInstance = new DeleteCompanyGroupUseCase(userRepository, companyGroupRepository);

const getCompanyContestsUseCaseInstance = new GetCompanyContestsUseCase(contestRepository, userRepository);
...
const updateCompanyContestStatusUseCaseInstance = new UpdateCompanyContestStatusUseCase(contestRepository);
const getContestParticipantsUseCaseInstance = new GetContestParticipantsUseCase(contestRepository, userRepository);
const getCompanyContestUseInstance = new GetContestUseCase(contestRepository, userRepository);
...
const getCompanyDashboardStatsUseCaseInstance = new GetCompanyDashboardStatsUseCase(
  userRepository,
  companyGroupRepository,
  contestRepository,
  lessonAssignmentRepository,
...
const notificationHistoryUseCaseInstance = new NotificationHistoryUseCase(notificationRepository, userRepository);
...
export const injectCompanyContestManagementController = new CompanyContestManagementController(
...
export const injectCompanyLessonManageController = new CompanyLessonManageController(
...
export const injectCompanyDashboardController = new CompanyDashboardController(
  getCompanyDashboardStatsUseCaseInstance
);
