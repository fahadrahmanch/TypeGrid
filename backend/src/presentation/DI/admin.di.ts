...
import { UpdateSubscriptionPlanUseCase } from "../../application/use-cases/admin/subscription/update-subscription-plan.use-case";
import { DeleteSubscriptionPlanUseCase } from "../../application/use-cases/admin/subscription/delete-subscription-plan.use-case";
...
const subscriptionRepository = new UserSubscriptionRepository(UserSubscription);
...
export const injectAdminDashboardController = new AdminDashboardController(getDashboardStatsUseCase);
...
const approveCompanyUseCase = new ApproveCompanyUseCase(companyRepository, userRepository, emailService);
const rejectCompanyUseCase = new RejectCompanyUseCase(companyRepository, emailService);
...
export const injectUserManageController = new UserManageController(getUsersUseCase, blockUserUseCase);
