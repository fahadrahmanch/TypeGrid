...
const changePasswordUseCaseInstance = new ChangePasswordUseCase(
  userRepository,
  hashService,
);
...
const createGroupPlayRoomUseCaseInstance = new CreateGroupPlayRoomUseCase(
  groupRepository,
  userRepository,
);
...
const joinGroupPlayGroupUseCaseInstance = new JoinGroupPlayGroupUseCase(
  groupRepository,
  userRepository,
);
...
export const injectTypingPracticeController = new TypingPracticeController(
  getPracticeTypingContentUseCaseInstance,
);
