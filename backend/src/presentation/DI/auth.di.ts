...
import { CompanyGoogleAuthUseCase } from "../../application/use-cases/auth/googleAuth/company-google-auth.use-case";
...
const resentOtpUseCase = new ResentOtpUseCase(otpService, emailService, authRepositoryInstance);
const completeSignup = new CompleteSignupUseCase(otpService, hashService, authRepositoryInstance);
...
const forgotPassword = new ForgotPasswordUseCase(otpService, emailService, authRepositoryInstance);
...
const companyGoogleAuthUseCase = new CompanyGoogleAuthUseCase(authRepositoryInstance, companyRepository);
