...
const startChallengeUseCaseInstance = new StartChallengeUseCase(challengeRepository, competitionRepository);
const saveChallengeResultUseCaseInstance = new SaveChallengeResultUseCase(
  challengeRepository,
  competitionRepository,
  resultRepository,
  companyUserStatsRepository,
...
export const injectChallengeSocketController = new ChallengeSocketController(
  ...
  saveChallengeResultUseCaseInstance
);
export const injectContestSocketController = new ContestSocketController(finishContestUseCaseInstance);
